    ...
    <div className="flex flex-col items-center justify-center min-w-96 mx-auto">
      <div className="w-full p-6 rounded-lg shadow-md bg-gray-900 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-0">
        ...
        <form>
          ...
          <a href="#" className="text-sm hover:underline hover:text-blue-500 mt-4 inline-block"> Already have an account</a>

          <div>
            <button className="btn btn-block btn-sm mt-2 border border-slate-500">Sign Up</button>
          </div>
